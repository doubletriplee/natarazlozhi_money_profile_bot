...
фоновой доставки уже усилены; до разрешения `true` остаются хранение платёжной истории, резервные
копии, мониторинг, юридические и фискальные проверки. Pilot всегда остаётся закрыт allowlist;
публичный production запрещён.
