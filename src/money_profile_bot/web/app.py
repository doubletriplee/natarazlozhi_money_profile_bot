...
<h2>Права пользователя</h2><p>Удалить имя, исходные данные, результаты, PDF и текст отзыва можно
...
по введённым пользователем данным. Результат состоит из шести оформленных блоков в одном PDF и выдаётся в Telegram.</p>
{payment_terms}
